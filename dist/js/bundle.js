...
function calcs() {
  ...
  function calc() {
    if (sizeValue > 0 && materialValue > 0) {
      ...
      calcResult.innerHTML = "Для расчета нужно выбрать размер картины и материал картины";
    }
  }
...
function forms() {
  ...
  popupTnanksClose.addEventListener("click", function () {
...
function maskedinput() {
  var maskFirst = document.querySelector('#mask1'),
  ...
  function mask(inputName, mask, evt) {
    ...
    try {
      ...
      var value = text.value; // If user pressed DEL or BACK SPACE, clean the value
...
function popups() {
  // 60seconds
  var timerId = setTimeout(cons, 60000),
      clicked = false;
  var designBtnBlock = document.getElementsByTagName("body")[0],
      //main-parent
  popupDesign = document.querySelector(".popup-design"),
      //popup-design
  consaltingPopup = document.querySelector(".popup-consultation"),
      //popup-consulting
...
function sliders() {
  ...
  var secondSlider = document.querySelectorAll(".feedback-slider-item"),
      secondSliderIndex = 1,
  ...
  showSecondSlides();
  var timerID; // таймер который нужно сбросить для анимации
  ...
  var timerIDFirst; // основной таймер который по нему меняются картинки
  ...
  function showSecondSlides(n) {
    ...
    secondSlider[secondSliderIndex - 1].classList.add("fadeInRightBig"); //left
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var accordion = __webpack_require__(/*! ./parts/accordion */ "./src/js/parts/accordion.js"),
      ...
      mask = __webpack_require__(/*! ./parts/maskedInput */ "./src/js/parts/maskedInput.js"),
